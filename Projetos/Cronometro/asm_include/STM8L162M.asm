...
; Port H at 0x5023
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.PH_ODR			DS.B 1		; Port H data output latch register
.PH_IDR			DS.B 1		; Port H input pin value register
.PH_DDR			DS.B 1		; Port H data direction register
.PH_CR1			DS.B 1		; Port H control register 1
.PH_CR2			DS.B 1		; Port H control register 2
...
reserved27		DS.B 63		; unused

; Advanced Encryption standard (AES) at 0x51d0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.AES_CR			DS.B 1		; AES Control Register
.AES_SR			DS.B 1		; AES Status Register
.AES_DINR			DS.B 1		; AES Data Input register
.AES_DOUTR			DS.B 1		; AES Data Output register
reserved28		DS.B 44		; unused
...
.DAC_CH1DORH			DS.B 1		; DAC channel 2 data output register high
.DAC_CH1DORL			DS.B 1		; DAC channel 2 data output register low
reserved46		DS.B 2		; unused
.DAC_CH2DORH			DS.B 1		; DAC channel 2 data output register high
.DAC_CH2DORL			DS.B 1		; DAC channel 2 data output register low
reserved47		DS.B 14		; unused
...
reserved51		DS.B 44		; unused
.LCD_CR4			DS.B 1		; LCD control register 4
gobackup1		DS.B {-45}		; go back up
