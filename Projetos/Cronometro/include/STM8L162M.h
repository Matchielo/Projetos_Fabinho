...
#ifndef __STM8L162M__
#define __STM8L162M__
...
/* STM8L162M */
	...
	#ifdef MCU_NAME
		#define STM8L162M 1
		#if (MCU_NAME != STM8L162M)
		#error "wrong include file STM8L162M.h for chosen MCU!"
		#endif
	#endif
...
DEF_8BIT_REG_AT(AES_CR,0x51d0);

/* AES Status Register */
DEF_8BIT_REG_AT(AES_SR,0x51d1);

/* AES Data Input register */
DEF_8BIT_REG_AT(AES_DINR,0x51d2);

/* AES Data Output register */
DEF_8BIT_REG_AT(AES_DOUTR,0x51d3);
