...
// VARIÁVEIS GLOBAIS
// ==============================================================================
// A DECLARAÇÃO 'extern' permite usar a variável definida em outro arquivo.


/* * Precisamos que a ISR "veja" a variável global que está no main.c
 * A palavra 'extern' diz ao compilador: "esta variável existe
 * em outro arquivo".
 */
...
INTERRUPT_HANDLER(TIM6_UPD_OVF_TRG_IRQHandler, 23)
 {
  /* In order to detect unexpected events during development,
     it is recommended to set a breakpoint on the following instruction.
  */
	// 1. Incrementa o nosso relógio global
	g_system_ticks++;
	
	// 2. Limpa a flag de interrupção (MUITO IMPORTANTE!)
	// Se você não limpar, o processador ficará preso nesta
