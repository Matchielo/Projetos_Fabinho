...
#ifndef __STM8L151FGK__
#define __STM8L151FGK__

/* STM8L151FGK */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define STM8L151FGK 1
		#if (MCU_NAME != STM8L151FGK)
		#error "wrong include file STM8L151FGK.h for chosen MCU!"
		#endif
	#endif
