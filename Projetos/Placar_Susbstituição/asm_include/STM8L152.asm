...
reserved11		DS.B 3		; unused

; System configuration (SYSCFG) at 0x509e
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
reserved24		DS.B 3		; unused
.RTC_WPR			DS.B 1		; Write Protection Register
reserved25		DS.B 2		; unused
...
.TIM1_DCR1			DS.B 1		; TIM1 DMA control register 1
.TIM1_DCR2			DS.B 1		; TIM1 DMA control register 2
.TIM1_DMAR			DS.B 1		; TIM1 DMA address for burst mode
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.DAC_CR1			DS.B 1		; DAC control register 1
.DAC_CR2			DS.B 1		; DAC control register 2
...
.DAC_RDHRH			DS.B 1		; DAC right aligned data holding register high
.DAC_RDHRL			DS.B 1		; DAC right aligned data holding register low
reserved39		DS.B 2		; unused
.DAC_LDHRH			DS.B 1		; DAC left aligned data holding register high
.DAC_LDHRL			DS.B 1		; DAC left aligned data holding register low
reserved40		DS.B 2		; unused
.DAC_DHR8			DS.B 1		; DAC 8-bit data holding register
reserved41		DS.B 27		; unused
.DAC_DORH			DS.B 1		; DAC data output register high
.DAC_DORL			DS.B 1		; DAC data output register low
reserved42		DS.B 82		; unused
...
.RI_RCR			DS.B 1		; Resistor control register 1
