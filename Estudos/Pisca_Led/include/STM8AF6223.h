...
#ifndef __STM8AF6223__
#define __STM8AF6223__
...
/* STM8AF6223 */
	...
	#ifdef MCU_NAME
		#define STM8AF6223 1
		#if (MCU_NAME != STM8AF6223)
		#error "wrong include file STM8AF6223.h for chosen MCU!"
		#endif
	#endif
...
DEF_8BIT_REG_AT(LINUART_SR,0x5230);

/* LINUART Data Register */
DEF_8BIT_REG_AT(LINUART_DR,0x5231);

/* LINUART Baud Rate Register 1 */
DEF_8BIT_REG_AT(LINUART_BRR1,0x5232);

/* LINUART Baud Rate Register 2 */
DEF_8BIT_REG_AT(LINUART_BRR2,0x5233);

/* LINUART Control Register 1 */
DEF_8BIT_REG_AT(LINUART_CR1,0x5234);

/* LINUART Control Register 2 */
DEF_8BIT_REG_AT(LINUART_CR2,0x5235);

/* LINUART Control Register 3 */
DEF_8BIT_REG_AT(LINUART_CR3,0x5236);

/* LINUART Control Register 4 */
DEF_8BIT_REG_AT(LINUART_CR4,0x5237);

/* LINUART Control Register 5 */
DEF_8BIT_REG_AT(LINUART_CR5,0x5238);

/* LINUART Control Register 6 */
DEF_8BIT_REG_AT(LINUART_CR6,0x5239);

/* LINUART Guard Time Register */
DEF_8BIT_REG_AT(LINUART_GTR,0x523a);

/* LINUART Prescaler Register */
DEF_8BIT_REG_AT(LINUART_PSCR,0x523b);
