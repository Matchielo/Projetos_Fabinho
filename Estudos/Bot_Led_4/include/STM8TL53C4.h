...
#ifndef __STM8TL53C4__
#define __STM8TL53C4__
...
/* STM8TL53C4 */
	...
	#ifdef MCU_NAME
		#define STM8TL53C4 1
		#if (MCU_NAME != STM8TL53C4)
		#error "wrong include file STM8TL53C4.h for chosen MCU!"
		#endif
	#endif
...
DEF_8BIT_REG_AT(I2C_OAR1L,0x5213);

/* I2C Own address register 1 high */
DEF_8BIT_REG_AT(I2C_OAR1H,0x5214);

/* I2C Own address register 2 */
DEF_8BIT_REG_AT(I2C_OAR2,0x5215);
...
/* PXS control register 1 */
DEF_8BIT_REG_AT(PXS_CR1,0x5300);

/* PXS control register 2 */
DEF_8BIT_REG_AT(PXS_CR2,0x5301);

/* PXS control register 3 */
DEF_8BIT_REG_AT(PXS_CR3,0x5302);

/* PXS interrupt and status register */
DEF_8BIT_REG_AT(PXS_ISR,0x5304);

/* PXS Clock control register 1 */
DEF_8BIT_REG_AT(PXS_CKCR1,0x5306);

/* PXS Clock control register 2 */
DEF_8BIT_REG_AT(PXS_CKCR2,0x5307);

/* PXS Receiver enable register */
DEF_16BIT_REG_AT(PXS_RXENR,0x5308);
/* PXS Receiver enable register high */
DEF_8BIT_REG_AT(PXS_RXENRH,0x5308);
/* PXS Receiver enable register low */
DEF_8BIT_REG_AT(PXS_RXENRL,0x5309);

/* PXS Receiver control register 1 */
DEF_16BIT_REG_AT(PXS_RXCR1,0x530a);
/* PXS Receiver control register 1 high */
DEF_8BIT_REG_AT(PXS_RXCR1H,0x530a);
/* PXS Receiver control register 1 low */
DEF_8BIT_REG_AT(PXS_RXCR1L,0x530b);

/* PXS Receiver control register 2 */
DEF_16BIT_REG_AT(PXS_RXCR2,0x530c);
/* PXS Receiver control register 2 high */
DEF_8BIT_REG_AT(PXS_RXCR2H,0x530c);
/* PXS Receiver control register 2 low */
DEF_8BIT_REG_AT(PXS_RXCR2L,0x530d);

/* PXS Receiver control register 3 */
DEF_16BIT_REG_AT(PXS_RXCR3,0x530e);
/* PXS Receiver control register 3 high */
DEF_8BIT_REG_AT(PXS_RXCR3H,0x530e);
/* PXS Receiver control register 3 low */
DEF_8BIT_REG_AT(PXS_RXCR3L,0x530f);

/* PXS Receiver inactive state register */
DEF_16BIT_REG_AT(PXS_RXINSR,0x5312);
/* PXS Receiver inactive state register high */
DEF_8BIT_REG_AT(PXS_RXINSRH,0x5312);
/* PXS Receiver inactive state register low */
DEF_8BIT_REG_AT(PXS_RXINSRL,0x5313);

/* PXS Transmit enable register */
DEF_16BIT_REG_AT(PXS_TXENR,0x5316);
/* PXS Transmit enable register high */
DEF_8BIT_REG_AT(PXS_TXENRH,0x5316);
/* PXS Transmit enable register low */
DEF_8BIT_REG_AT(PXS_TXENRL,0x5317);

/* PXS Maximum counter value register */
DEF_16BIT_REG_AT(PXS_MAXR,0x531a);
/* PXS Maximum counter value register high */
DEF_8BIT_REG_AT(PXS_MAXRH,0x531a);
/* PXS Maximum counter value register low */
DEF_8BIT_REG_AT(PXS_MAXRL,0x531b);

/* PXS Maximum counter enable register */
DEF_16BIT_REG_AT(PXS_MAXENR,0x531c);
/* PXS Maximum counter enable register high */
DEF_8BIT_REG_AT(PXS_MAXENRH,0x531c);
/* PXS Maximum counter enable register low */
DEF_8BIT_REG_AT(PXS_MAXENRL,0x531d);

/* PXS Receiver status register */
DEF_16BIT_REG_AT(PXS_RXSR,0x531e);
/* PXS Receiver status register high */
DEF_8BIT_REG_AT(PXS_RXSRH,0x531e);
/* PXS Receiver status register low */
DEF_8BIT_REG_AT(PXS_RXSRL,0x531f);

/* PXS Counter receiver channel 0 */
DEF_16BIT_REG_AT(PXS_RX0CNTR,0x5320);
/* PXS Counter receiver channel 0 register high */
DEF_8BIT_REG_AT(PXS_RX0CNTRH,0x5320);
/* PXS Counter receiver channel 0 register low */
DEF_8BIT_REG_AT(PXS_RX0CNTRL,0x5321);

/* PXS Counter receiver channel 1 */
DEF_16BIT_REG_AT(PXS_RX1CNTR,0x5322);
/* PXS Counter receiver channel 1 register high */
DEF_8BIT_REG_AT(PXS_RX1CNTRH,0x5322);
/* PXS Counter receiver channel 1 register low */
DEF_8BIT_REG_AT(PXS_RX1CNTRL,0x5323);

/* PXS Counter receiver channel 2 */
DEF_16BIT_REG_AT(PXS_RX2CNTR,0x5324);
/* PXS Counter receiver channel 2 register high */
DEF_8BIT_REG_AT(PXS_RX2CNTRH,0x5324);
/* PXS Counter receiver channel 2 register low */
DEF_8BIT_REG_AT(PXS_RX2CNTRL,0x5325);

/* PXS Counter receiver channel 3 */
DEF_16BIT_REG_AT(PXS_RX3CNTR,0x5326);
/* PXS Counter receiver channel 3 register high */
DEF_8BIT_REG_AT(PXS_RX3CNTRH,0x5326);
/* PXS Counter receiver channel 3 register low */
DEF_8BIT_REG_AT(PXS_RX3CNTRL,0x5327);

/* PXS Counter receiver channel 4 */
DEF_16BIT_REG_AT(PXS_RX4CNTR,0x5328);
/* PXS Counter receiver channel 4 register high */
DEF_8BIT_REG_AT(PXS_RX4CNTRH,0x5328);
/* PXS Counter receiver channel 4 register low */
DEF_8BIT_REG_AT(PXS_RX4CNTRL,0x5329);

/* PXS Counter receiver channel 5 */
DEF_16BIT_REG_AT(PXS_RX5CNTR,0x532a);
/* PXS Counter receiver channel 5 register high */
DEF_8BIT_REG_AT(PXS_RX5CNTRH,0x532a);
/* PXS Counter receiver channel 5 register low */
DEF_8BIT_REG_AT(PXS_RX5CNTRL,0x532b);

/* PXS Counter receiver channel 6 */
DEF_16BIT_REG_AT(PXS_RX6CNTR,0x532c);
/* PXS Counter receiver channel 6 register high */
DEF_8BIT_REG_AT(PXS_RX6CNTRH,0x532c);
/* PXS Counter receiver channel 6 register low */
DEF_8BIT_REG_AT(PXS_RX6CNTRL,0x532d);

/* PXS Counter receiver channel 7 */
DEF_16BIT_REG_AT(PXS_RX7CNTR,0x532e);
/* PXS Counter receiver channel 7 register high */
DEF_8BIT_REG_AT(PXS_RX7CNTRH,0x532e);
/* PXS Counter receiver channel 7 register low */
DEF_8BIT_REG_AT(PXS_RX7CNTRL,0x532f);

/* PXS Counter receiver channel 8 */
DEF_16BIT_REG_AT(PXS_RX8CNTR,0x5330);
/* PXS Counter receiver channel 8 register high */
DEF_8BIT_REG_AT(PXS_RX8CNTRH,0x5330);
/* PXS Counter receiver channel 8 register low */
DEF_8BIT_REG_AT(PXS_RX8CNTRL,0x5331);

/* PXS Counter receiver channel 9 */
DEF_16BIT_REG_AT(PXS_RX9CNTR,0x5332);
/* PXS Counter receiver channel 9 register high */
DEF_8BIT_REG_AT(PXS_RX9CNTRH,0x5332);
/* PXS Counter receiver channel 9 register low */
DEF_8BIT_REG_AT(PXS_RX9CNTRL,0x5333);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX0CSSELR,0x5340);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX1CSSELR,0x5341);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX2CSSELR,0x5342);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX3CSSELR,0x5343);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX4CSSELR,0x5344);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX5CSSELR,0x5345);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX6CSSELR,0x5346);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX7CSSELR,0x5347);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX8CSSELR,0x5348);

/* PXS receiver sampling capacitor selection */
DEF_8BIT_REG_AT(PXS_RX9CSSELR,0x5349);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX0EPCCSELR,0x5350);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX1EPCCSELR,0x5351);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX2EPCCSELR,0x5352);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX3EPCCSELR,0x5353);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX4EPCCSELR,0x5354);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX5EPCCSELR,0x5355);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX6EPCCSELR,0x5356);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX7EPCCSELR,0x5357);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX8EPCCSELR,0x5358);

/* PXS receiver electrode parasitic compensation capacitor selection */
DEF_8BIT_REG_AT(PXS_RX9EPCCSELR,0x5359);
