...
#ifndef __STM8L151C2C3__
#define __STM8L151C2C3__

/* STM8L151C2C3 */

	/* Check MCU name */
	#ifdef MCU_NAME
		#define STM8L151C2C3 1
		#if (MCU_NAME != STM8L151C2C3)
		#error "wrong include file STM8L151C2C3.h for chosen MCU!"
		#endif
	#endif
...
DEF_8BIT_REG_AT(RI_CR,0x5450);

/* I/O mask register 1 */
DEF_8BIT_REG_AT(RI_MASKR1,0x5451);

/* I/O mask register 2 */
DEF_8BIT_REG_AT(RI_MASKR2,0x5452);

/* I/O mask register 3 */
DEF_8BIT_REG_AT(RI_MASKR3,0x5453);

/* I/O mask register 4 */
DEF_8BIT_REG_AT(RI_MASKR4,0x5454);

/* I/O input register 4 */
DEF_8BIT_REG_AT(RI_IOIR4,0x5455);

/* I/O control mode register 4 */
DEF_8BIT_REG_AT(RI_IOCMR4,0x5456);

/* I/O switch register 4 */
DEF_8BIT_REG_AT(RI_IOSR4,0x5457);
