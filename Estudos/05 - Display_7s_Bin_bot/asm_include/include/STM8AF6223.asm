...
; LIN Universal asynch. receiver transmitter (LINUART) at 0x5230
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
.LINUART_CR5			DS.B 1		; LINUART Control Register 5
.LINUART_CR6			DS.B 1		; LINUART Control Register 6
.LINUART_GTR			DS.B 1		; LINUART Guard Time Register
.LINUART_PSCR			DS.B 1		; LINUART Prescaler Register
reserved15		DS.B 20		; unused
...
.TIM5_CCMR3			DS.B 1		; TIM5 Capture/Compare mode register 3
.TIM5_CCER1			DS.B 1		; TIM5 Capture/Compare enable register 1
.TIM5_CCER2			DS.B 1		; TIM5 Capture/Compare enable register 2
.TIM5_CNTRH			DS.B 1		; Data bits High
.TIM5_CNTRL			DS.B 1		; Data bits Low
.TIM5_PSCR			DS.B 1		; TIM5 Prescaler register
.TIM5_ARRH			DS.B 1		; Data bits High
.TIM5_ARRL			DS.B 1		; Data bits Low
.TIM5_CCR1H			DS.B 1		; Data bits High
.TIM5_CCR1L			DS.B 1		; Data bits Low
.TIM5_CCR2H			DS.B 1		; Data bits High
.TIM5_CCR2L			DS.B 1		; Data bits Low
.TIM5_CCR3H			DS.B 1		; Data bits High
.TIM5_CCR3L			DS.B 1		; Data bits Low
reserved17		DS.B 41		; unused

; 8-Bit  Timer 6 (TIM6) at 0x5340
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
.TIM6_CR1			DS.B 1		; TIM6 Control register 1
.TIM6_CR2			DS.B 1		; TIM6 Control register 2
.TIM6_SMCR			DS.B 1		; TIM6 Slave Mode Control register
.TIM6_IER			DS.B 1		; TIM6 Interrupt enable register
.TIM6_SR			DS.B 1		; TIM6 Status register
.TIM6_EGR			DS.B 1		; TIM6 Event Generation register
.TIM6_CNTR			DS.B 1		; TIM6 Counter
.TIM6_PSCR			DS.B 1		; TIM6 Prescaler register
.TIM6_ARR			DS.B 1		; TIM6 Auto-reload register
reserved18		DS.B 151		; unused

; 10-Bit A/D Converter (ADC) at 0x53e0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
